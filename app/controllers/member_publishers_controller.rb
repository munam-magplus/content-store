class MemberPublishersController < ApplicationController
  ...
  def member_publisher_params
    ...
    :member_publisher_status, :contact_first_name, :contact_last_name, :contact_email, :publisher_borrow_period, :revenue_share_percentage,:country_code, :member_publisher_logo)
  end
