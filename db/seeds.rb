...
Country.create(country_name:"Northern Ireland",country_code:"NIR" )
...
Country.create(country_name:"Morocco",country_code:"MR" )
...
User.create(email: "test@gmail.com",password: "123456", admin: "false")